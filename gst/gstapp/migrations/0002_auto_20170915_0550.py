# -*- coding: utf-8 -*-
# Generated by Django 1.11.1 on 2017-09-15 12:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bus', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='gstapp.businesses')),
            ],
        ),
        migrations.AddField(
            model_name='b2c_txn',
            name='prod',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='gstapp.products'),
        ),
        migrations.AddField(
            model_name='b2c_txn',
            name='seller_gst',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='gstapp.businesses'),
        ),
        migrations.AddField(
            model_name='b2b_txn',
            name='buyer_gst',
        ...
        migrations.AddField(
            model_name='b2b_txn',
            name='seller_gst',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='gstapp.businesses'),
        ),
    ]
